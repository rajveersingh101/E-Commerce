...
httpRequest.onreadystatechange = function() {
    if(this.readyState === 4 && this.status == 200) {
        ...
        // Fire page load view_item event
        window.dataLayer = window.dataLayer || [];
        window.dataLayer.push({
            event: 'view_item',
            ecommerce: {
                items: [{
                    item_id: contentDetails.id || '',
                    item_name: contentDetails.name || '',
                    item_brand: contentDetails.brand || '',
                    price: contentDetails.price || '',
                    item_image: contentDetails.preview || ''
                }]
            }
        });
